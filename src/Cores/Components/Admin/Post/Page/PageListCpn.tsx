...
export default function PageListCpn(props: Readonly<FormPropsModel<unknown>>) {
  //#region Constants
  const myPathName = "/admin/page";
  const tableId = "page_manage";
  ...
  function handleGetList(
    ...
    CorePageService.GetList(filterRequest, cancelGetListRef.current)
      .then((res) => {
        if (res.isSuccess) {
