...
import PostCategoryInternalFormCpn from "@src/Cores/Components/Admin/Post/PostCategoryInternal/PostCategoryInternalFormCpn";
import PostCategoryInternalListCpn from "@src/Cores/Components/Admin/Post/PostCategoryInternal/PostCategoryInternalListCpn";
...
export default function PostCategoryInternalPage() {
  //#region Constants
  const myPathName = "/admin/post-category-internal";
