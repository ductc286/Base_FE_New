...
export default function PageInternalListCpn(
  props: Readonly<FormPropsModel<unknown>>
) {
  //#region Constants
  const myPathName = "/admin/page-internal";
  const tableId = "page-internal_manage";
  ...
  function handleGetList(
    ...
    CorePageInternalService.GetList(filterRequest, cancelGetListRef.current)
      .then((res) => {
        if (res.isSuccess) {
