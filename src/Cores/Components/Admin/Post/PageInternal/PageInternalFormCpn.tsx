...
import CorePageInternalService from "@src/Cores/Services/Admin/Post/CorePageInternalService";
import {
  CorePostEntity,
...
export default function PageInternalFormCpn(
  ...
  function initData() {
    ...
    CorePostCategoryService.GetListSelect().then((res) => {
  ...
  function getData(formModeParam?: FormModeEnum, recordId?: string) {
    ...
    CorePageInternalService.Get(recordId ?? currentRecordId)
      .then((res) => {
        if (res.isSuccess) {
          loadData(
  ...
  function add(formDataParam: CorePostEntity) {
    ...
    CorePageInternalService.Add(formDataParam)
      .then((res) => {
        if (res.isSuccess) {
  ...
  function edit(formDataParam: CorePostEntity) {
    ...
    CorePageInternalService.Update(formDataParam)
      .then((res) => {
        if (res.isSuccess) {
          useToastState.showToast(NotifyTypeEnum.success, res.message);
          getData();
          ...
          {authorizeAction.requestApproval && (
            <ButtonTcd
              ...
              onClick={() => {
                ...
                CorePageInternalService.RequestApprove({
          ...
          {authorizeAction.approve && (
            <ButtonTcd
              ...
              onClick={() => {
                ...
                CorePageInternalService.Approve({
                  recordId: formData.corePostId,
                })
                  .then((res) => {
                    if (res.isSuccess) {
          ...
          {authorizeAction.publish && (
            <ButtonTcd
              ...
              onClick={() => {
                ...
                CorePageInternalService.Publish({
                  recordId: formData.corePostId,
                })
                  .then((res) => {
                    if (res.isSuccess) {
              ...
              onClick={() => {
                useConfirmModalState.confirm({
                  ...
                  onOk: (note) => {
                    ...
                    CorePageInternalService.Reject({
                      recordId: formData.corePostId,
                      note,
                    })
                      .then((res) => {
              ...
              onClick={() => {
                useConfirmModalState.confirm({
                  ...
                  onOk: (note?: string) => {
                    ...
                    CorePageInternalService.CancelRequestApproval({
                      recordId: formData.corePostId,
                      note: note,
                    })
                      .then((res) => {
              ...
              onClick={() => {
                useConfirmModalState.confirm({
                  ...
                  onOk: (note) => {
                    ...
                    CorePageInternalService.CancelApprove({
                      recordId: formData.corePostId,
                      note,
                    })
                      .then((res) => {
              ...
              onClick={() => {
                useConfirmModalState.confirm({
                  ...
                  onOk: (note) => {
                    ...
                    CorePageInternalService.CancelPublish({
                      recordId: formData.corePostId,
                      note,
                    })
                      .then((res) => {
              ...
              onClick={() => {
                useConfirmModalState.confirm({
                  ...
                  onOk: (note) => {
                    ...
                    CorePageInternalService.Cancel({
                      recordId: formData.corePostId,
                      note,
                    })
                      .then((res) => {
              ...
              onClick={() => {
                useConfirmModalState.confirm({
                  ...
                  onOk: () => {
                    ...
                    CorePageInternalService.Delete(formData.corePostId)
                      .then((res) => {
                        if (res.isSuccess) {
                          useToastState.showToast(
                            NotifyTypeEnum.success,
          ...
          <UpLoadTcd
            ...
            onChange={(dataPram: InputChangeModel) => {
              dataPram.value.length > 0 &&
                CorePageInternalService.UploadImage(dataPram.value[0]).then(
                  (res) => {
                    if (res.isSuccess) {
                      useToastState.showToast(
                        NotifyTypeEnum.success,
