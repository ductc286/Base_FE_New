...
import { CancelTokenService, CorePostService } from "@src/Cores/Services";
import {
  CorePostEntity,
  CorePostFilter,
...
export default function PostCategoryPageCpn(
  ...
  //#region Constants
  const myPathName = "/admin/post";
  const tableId = "post_manage";
  ...
  function handleGetList(
    ...
    CorePostService.GetList(filterRequest, cancelGetListRef.current)
      .then((res) => {
        if (res.isSuccess) {
